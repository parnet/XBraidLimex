            ...
            static void DomainAlgebra(Registry &reg, string grp) {
...

                {
                    ...
                    reg.add_class_<T, TBase>(name, grp)
                            ...
                            .
                                    template add_constructor<void (*)(const char *, const char */*, number*/)>(
                                    "fctNames, subsetNames, scale")
                            .set_construct_as_smart_pointer(true);
...

                {
                    ...
                    reg.add_class_<T, TBase>(name, grp)
                            ...
                            .add_method("apply", (void (T::*)(SmartPtr<TGridFunction> u, number time,
                                                              ConstSmartPtr<TGridFunction> u0, number time0)) &T::apply,
                                        "", "")
...

                {
                    ...
                    reg.add_class_<T, TBase>(name, grp)
                            .template add_constructor<void (*)(SmartPtr<TTimeDisc>, SmartPtr<TTimeDisc>)>(
                                    "tdisc1, tdisc2")
                            .add_method("apply", (void (T::*)(SmartPtr<TGridFunction> u, number time,
                                                              ConstSmartPtr<TGridFunction> u0, number time0)) &T::apply,
                                        "", "")
...

                {
                    ...
                    reg.add_class_<T, TBase>(name, grp)
                            ...
                            .add_method("apply", (bool (T::*)(SmartPtr<TGridFunction> u, number time,
                                                              ConstSmartPtr<TGridFunction> u0, number time0)) &T::apply,
                                        "", "")
                            .add_method("set_derivative", &T::set_derivative)
                            .set_construct_as_smart_pointer(true);
...

                {
                    ...
                    reg.add_class_<T, TBase>(name, grp)
                            ...
                            .add_method("add_stage",
                                        (void (T::*)(size_t, size_t, SmartPtr<typename T::domain_discretization_type>,
                                                     SmartPtr<typename T::solver_type>)) &T::add_stage)
                            .add_method("add_stage", (void (T::*)(size_t, SmartPtr<typename T::solver_type>,
                                                                  SmartPtr<typename T::domain_discretization_type>)) &T::add_stage)
                            .add_method("add_stage", (void (T::*)(size_t, SmartPtr<typename T::solver_type>,
                                                                  SmartPtr<typename T::domain_discretization_type>,
                                                                  SmartPtr<typename T::domain_discretization_type>)) &T::add_stage_ext)
...
*/
                //	LinearlyImplicitEuler
                {
                    ...
                    grp.append("/Discretization/TimeDisc");
                    ...
                    reg.add_class_<T, TBase>(name, grp)
                            .template add_constructor<void (*)(SmartPtr<IDomainDiscretization<TAlgebra> >)>(
                                    "LinearImplicitEuler")
